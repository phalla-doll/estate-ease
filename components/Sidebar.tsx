...
export default function Sidebar() {
  return (
    <div className="w-[280px] flex-shrink-0 bg-white rounded-2xl border border-slate-100 flex flex-col overflow-hidden shadow-sm h-fit">
        ...
        <div className="space-y-3.5 px-1">
          ...
          <div className="pt-3 pb-1">
            ...
            <div className="relative h-1 bg-slate-100 rounded-full">
              ...
              <div className="absolute left-1/4 top-1/2 -translate-y-1/2 w-3.5 h-3.5 bg-blue-600 border-2 border-white rounded-full shadow-sm cursor-pointer hover:scale-110 transition-transform"></div>
              <div className="absolute right-1/4 top-1/2 -translate-y-1/2 w-3.5 h-3.5 bg-blue-600 border-2 border-white rounded-full shadow-sm cursor-pointer hover:scale-110 transition-transform"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-5">
        ...
        <div className="flex flex-wrap gap-2.5">
          <button className="px-5 py-2 bg-blue-600 text-white text-[14px] rounded-full font-medium shadow-sm hover:bg-blue-700 transition-colors">Garden</button>
