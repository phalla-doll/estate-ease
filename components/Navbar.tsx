  ...
  return (
    <nav className="bg-white px-8 py-4 flex items-center justify-between border-b border-slate-100 sticky top-0 z-20">
      <div className="flex items-center gap-3">
        <div className="bg-slate-900 text-white p-2.5 rounded-full">
          <Home size={22} />
        </div>
      ...
      <div className="hidden lg:flex items-center gap-8 text-sm font-medium text-slate-500">
        <a href="#" className="text-blue-600 bg-blue-50 px-5 py-2 rounded-full font-medium">Buy</a>
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-3">
          <button className="p-2.5 border border-slate-100 rounded-full hover:bg-slate-50 transition-colors text-slate-600">
            <MessageSquare size={18} />
          </button>
          <button className="p-2.5 border border-slate-100 rounded-full hover:bg-slate-50 transition-colors text-slate-600 relative">
            <Bell size={18} />
